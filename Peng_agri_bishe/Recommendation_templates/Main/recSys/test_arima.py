...
root_path = os.getcwd() + "/app_templates/Main/recSys"
...
def get_min_max_degree():
	...
	#data_df = pd.read_csv(root_path + "/data/weather.csv")
...
if __name__ == '__main__':
	...
	pre1, pre2 = get_min_max_degree()
	print pre1
	print pre2
	data_list1 = min_list + pre1
	data_list2 = min_list + pre2

	pd.Series(data_list1).plot()
	pd.Series(data_list2).plot()
	plt.show();
