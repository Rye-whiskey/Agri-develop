...
from app_templates.Main.paserManager.newsContent import *
from app_templates.Main.paserManager.price import Price
...
if __name__ == '__main__':
	...
	from app_templates.Main.paserManager.util import CorrectIp
	ci = CorrectIp()
