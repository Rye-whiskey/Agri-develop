...
class CorrectIp():
    ...
    #     ipList = []
    #     urlList = []
    #     from app_templates.Main.paserManager.util import HttpUtil
    ...
    #         from app_templates.Main.paserManager.tools.replaceTool import Tool
    ...
    def Ip(self,proxy):
        ...
        try:
            ...
            if res.status_code == 200:
                print('.......可用ip.......',proxy)
                from app_templates.Main.main import ROOT_PATH
