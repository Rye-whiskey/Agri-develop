...
import os
import json
from app_templates.Main.paserManager.newsContentPaser import *
from app_templates.Main.dbManager.mongoClass import MongoOperator
from app_templates.Main.recSys.knn import get_K_nearst_love
from app_templates.Main.recSys.arima import get_min_max_degree
from app_templates.pager import  Pagination
from app_templates.Main.paserManager.newsContentPaser import paserWeather
from app_templates.models import *
...
def index(request, data={}):
    ...
    return render(request, ROOT_URL + "/app_templates/templates/homepage.html", data)  # 注意路径一定要写对
def test(request):
	print ("class_1 ......")
	try:
	...
	return render(request, ROOT_URL +"/app_templates/templates/test.html",{'data':data_list,'page_obj':page_obj})
# 第一类新闻 农业新闻
def class_1(request, data={}):
    ...
    return render(request, ROOT_URL + "/app_templates/templates/class_1.html", data)  # 注意路径一定要写对
...
def class_2(request):
    ...
    try:
        ...
        return index(request)
    return render(request, ROOT_URL + "/app_templates/templates/class_2.html", {'data': data_list, 'page_obj': page_obj})


def news(request,data={}):
	return render(request,ROOT_URL+"/app_templates/templates/news.html",data)
...
def class_3(request):
    ...
    try:
        ...
        return index(request)
    return render(request, ROOT_URL + "/app_templates/templates/class_3.html",{'data': data_list, 'page_obj': page_obj})
...
def class_4(request, data={}):
    ...
    try:
        ...
        return index(request)
    return render(request, ROOT_URL + "/app_templates/templates/class_4.html", data)  # 注意路径一定要写对
...
def myRecommend(request, data={}):
    ...
    try:
        ...
        return index(request)
    return render(request, ROOT_URL + "/app_templates/templates/myRecommend.html", data)  # 注意路径一定要写对
...
def history(request):
    ...
    try:
        ...
        return index(request)
    return render(request, ROOT_URL + "/app_templates/templates/history.html", data)  # 注意路径一定要写对
...
def weather(request):
    ...
    try:
        ...
        return index(request)
    return render(request, ROOT_URL + "/app_templates/templates/weather.html", data)  # 注意路径一定要写对


##############################################################################################################################################

def weatherTest(request):
    # from app_templates.Main.paserManager.weather import Weather
    # weather = Weather()
